...
# No se si este mal las direcciones, pero no las quiero borrar :v
# NEX_PATH_UEFI := build/iso/80x86/i386/kernel/uefi
# NEX_PATH_BIOS := build/iso/80x86/i386/kernel/bios

NEX_PATH_UEFI := build/iso/80x86/amd64/multiboot/uefi
NEX_PATH_BIOS := build/iso/80x86/amd64/multiboot/bios
